...
%  - out.xyz_yz
%  - out.xyz_xz
%  - out.surf_X, out.surf_Y, out.surf_Z
%  - out.h_surf (if not noplot)
% 
%  you can draw surface, 
%    surf(out.surf_X, out.surf_Y, out.surf_Z)
% 
%  2 dimentional data
%  - out.xy
%  - out.h (if not noplot)
%
% Modified from https://kr.mathworks.com/matlabcentral/fileexchange/4705-error-ellipse
%
% Revised by Wani Woo: 
%
%   - changed output, now you can get xyz coordinates, and draw surf or
%     plots yourself.
%   - added an optional input, 'noplot'
...
elseif r==2 && c==2
    ...
    out.xy = [scale*(x0+k*x),scale*(y0+k*y)];
    if doplot
...
n=1000; % Number of points around ellipse
